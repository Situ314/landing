...
<div class="col-md-12" style="padding-left:0px; padding-right:0px; position:relative; text-align:center; width:100%">
<div class="crop" id="crop"><img class="land2_banner" id="land2_banner" src="http://data.1freewallpapers.com/download/dark-living-room.jpg" style="height:500px; overflow:visible; width:1400px" /></div>

<div style="left:20px; position:absolute; top:20px"><img class="img-responsive" id="land2_logo1" src="https://medic-trust.com/assets/logo-icon-9b77a4d938aa060a0e998bceb1e90fb3.png" style="height:200px; width:200px" />
...
<p><a class="button" data-toggle="modal" data-target="#myModal" href="#" style="background-color: #F9AF04;color: #fff;height:55px; text-decoration: none;">DESCARGAR LOS VIDEOS AHORA </a></p>
</div>
</div>
</div>
...
- Una m&aacute;s</p>
<input name="PixeBoton" type="hidden" value="" />
<div style="text-align:center"><a class="button" data-toggle="modal" data-target="#myModal" href="#" style="background-color: #F9AF04;color: #fff;height:55px; text-decoration: none;">DESCARGAR LOS VIDEOS AHORA</a></div>
...
<div class="col-md-12" style="padding-left:0px; padding-right:0px; position:relative; text-align:center"><img id="naranja" src="https://i.pinimg.com/originals/91/27/db/9127db783da0fb31b36f24fd5b4195a2.jpg" style="height:180px; max-height:100%; width:100%" />
...
<div class="row" id="row6" style="background-color:#00722a; color:white; padding-left:0px; padding-right:0px; padding:10px; position:relative; text-align:center"><img class="img-fluid" src="http://localhost:8080/landing/public/img/images/Leads.png" style="height:69px; left:10%; position:absolute; top:50%; transform:translate(-10%, -50%); width:200px" />
<div class="footer" id="footer" style="text-align:center; width:100%">
<p>Esta Promoci&oacute;n finaliza el 19/05/2018</p>

<p>De Chali 2018 ll Todos los derechos reservados<br />
Visita nuestro sitio web<br />
<a href="www.dechali.com">www.dechali.com</a></p>
<img src="http://localhost:8080/landing/public/img/images/Facebook.png" /> <img src="http://localhost:8080/landing/public/img/images/Twitter.png" /> <img src="http://localhost:8080/landing/public/img/images/Whatsapp.png" /></div>
</div>
</div>

<p><input name="CodLanding" type="hidden" value="23" /> <input name="Nombre" type="hidden" value="DeChaLi" /> <input name="Desde" type="hidden" value="2018-05-18" /> <input name="Hasta" type="hidden" value="2018-05-19" /> <input name="ContadorVisitas" type="hidden" value="" /> <input name="ContadorClics" type="hidden" value="" /> <!--Modal--></p>
...
<form onsubmit="mensaje()" action="http://localhost:8080/landing/public/index.php/guardar" method="POST"><input name="_token" type="hidden" value="5rZqxIItl75UqE814NnQaYQ6UcFLzNvBrmWiB6n1" /> <input name="id_landing" type="hidden" value="23" />
...
var countDownDate = new Date("2018-05-19 23:59:59").getTime();
