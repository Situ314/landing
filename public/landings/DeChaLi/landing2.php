...
<p>Esta Promoci&oacute;n finaliza el 10/04/2018</p>
...
<p><input name="CodLanding" type="hidden" value="2" /> <input name="Nombre" type="hidden" value="DeChaLi" /> <input name="Desde" type="hidden" value="2018-04-03" /> <input name="Hasta" type="hidden" value="2018-04-10" /> <input name="ContadorVisitas" type="hidden" value="" /> <input name="ContadorClics" type="hidden" value="" /> <!--Modal--></p>
...
<form onsubmit="mensaje()" action="http://dechali.com/lead/public/index.php/guardar" method="POST"><input name="_token" type="hidden" value="JDukjrMXcomjy8vCngvLcN7JQZIci7gKxcAtpyRw" /> <input name="id_landing" type="hidden" value="2" />
...
var countDownDate = new Date("2018-04-10 23:59:59").getTime();
