...
<div class="row">
<div class="col-md-5" style="overflow:hidden"><img alt="CKEditor logo" class="img-fluid" src="http://dechali.com/lead/public/img/images/Post%206%20de%20Agosto%20opcion%202.jpg" style="height:500px; width:450px" /></div>
...
<h3 style="text-align:center">T&Iacute;TULO CUATRO</h3>
</div>
</div>
...
<p>Promoci&oacute;n gratuita</p>

<p><span style="color:#f1c40f"><span style="font-size:18px"><strong>CONT&Aacute;CTANOS AHORA</strong></span></span></p>
</div>
</div>
</div>
...
<p><input name="PixeBoton" type="hidden" value="" /> <a class="button" data-toggle="modal" data-target="#myModal" href="#" style="background-color: #F9AF04;color: #fff;height:55px; text-decoration: none;">QUIERO LA CALAMINA POR FAVOR</a> <!--<a data-toggle="modal" data-target="#myModal" href="#" data-toggle="modal" data-target="#myModal" data-dismiss="modal" onclick="modal(20)" id="landing-20">SI, DESEO ACCEDER A LA CAMPAÑA GRATUITA</a>--></p>
</div>
</div>
</div>
...
<p>Esta Promoci&oacute;n finaliza el 17/05/2018</p>
...
<p><input name="CodLanding" type="hidden" value="20" /> <input name="Nombre" type="hidden" value="DeChaLi" /> <input name="Desde" type="hidden" value="2018-05-09" /> <input name="Hasta" type="hidden" value="2018-05-17" /> <input name="ContadorVisitas" type="hidden" value="" /> <input name="ContadorClics" type="hidden" value="" /> <!--modal--></p>
...
<form onsubmit="mensaje()" action="http://dechali.com/lead/public/index.php/guardar" method="POST"><input name="_token" type="hidden" value="3Fhq6jbj5AvPxaSJpCEsBNnGFq18YWlUJ2wm71nn" /> <input name="id_landing" type="hidden" value="20" />
...
var countDownDate = new Date("2018-05-17 23:59:59").getTime();
