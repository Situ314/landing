...
<div class="row">
<div class="col-md-12"><img class="plan3_banner" src="http://dentalceo.com.bo/wp-content/themes/medicalpress15/inspiry-medicalpress/images/logo_dechali.png" style="display:block; margin-left:auto; margin-right:auto" /></div>
</div>
...
<h1 style="margin-left:0px; margin-right:0px"><span style="font-size:48px" id="tdias">1</span></h1>
</div>
...
<h1 style="margin-left:0px; margin-right:0px"><span style="font-size:48px"id="thoras">0</span></h1>
</div>
...
<div class="col-md-3" style="padding:3px">
<div style="background:#002060; border-color:white; border-radius:5px; border-style:solid; border-width:2px; color:white; font-size:300%; padding:5px">
<h1 style="margin-left:0px; margin-right:0px"><span style="font-size:48px"id="tsegundos">50</span></h1>
</div>
...
<input name="PixeBoton" type="hidden" value="" />
<p><a class="button" data-toggle="modal" data-target="#myModal" href="#" style="background-color: #F9AF04;color: #fff;height:55px; text-decoration: none;">INSCRIBEME AL WEBINAR GRATIS </a></p>
&nbsp;
...
<p><img src="http://localhost:8080/landing/public/img/images/Facebook.png" style="height:50px; width:50px" /> <img src="http://localhost:8080/landing/public/img/images/Twitter.png" style="height:50px; width:50px" /> <img src="http://localhost:8080/landing/public/img/images/Whatsapp.png" style="height:50px; width:50px" /></p>
</div>
</div>
</div>

<div class="row" id="row6">
<div class="col-md-12" style="background:#00722a; position:relative"><img class="img-fluid" src="http://localhost:8080/landing/public/img/images/Leads.png" style="height:69px; left:10%; position:absolute; top:50%; transform:translate(-10%, -50%); width:200px" />
<div class="footer" id="footer">
<p>Esta promoci&oacute;n finaliza el 23/05/2018<br />
<br />
...
<p><input name="CodLanding" type="hidden" value="1" /> <input name="Nombre" type="hidden" value="DeChaLi" /> <input name="Desde" type="hidden" value="2018-04-01" /> <input name="Hasta" type="hidden" value="2018-05-23" /> <input name="ContadorVisitas" type="hidden" value="" /> <input name="ContadorClics" type="hidden" value="" /> <!--Modal--></p>
...
<form onsubmit="mensaje()" action="http://localhost/lad/public/index.php/guardar" method="POST"><input name="_token" type="hidden" value="lrNTyuMHo8lN7TqNihYvId6jimtU5FflmLChQY0D" /> <input name="id_landing" type="hidden" value="1" />
...
<div class="col-md-12"><select name="campo2" required=""><option value="1|1">La Paz</option><option value="1|2">Cochabamba</option><option value="1|3">Oruro</option><option value="1|4">Potosi</option><option value="1|5">Santa Cruz</option><option value="1|6">Tarija</option><option value="1|7">Chuquisaca</option><option value="1|8">Beni</option><option value="1|9">Pando</option> </select></div>
</div>

<div class="form-group">
<div class="col-md-12">Servicios*:</div>

<div class="col-md-12"><select name="campo3" required=""><option value="2|10">Sitios Web</option><option value="2|11">Campa&ntilde;as Publicitarias en Facebook</option><option value="2|12">Identidad Corporativa</option><option value="2|13">Desarrollo de Sistemas</option><option value="2|14">Talleres de Entrenamiento Corporativo</option><option value="2|15">Plan de Marketing Integral</option> </select></div>
</div>
...
var countDownDate = new Date("2018-05-23 23:59:59").getTime();
