...
<div style="left:20px; position:absolute; top:20px"><img class="img-responsive" src="http://dechali.com/lead/public/img/images/Pinterest.png" style="height:128px; width:128px" />
...
<p><input name="CodLanding" type="hidden" value="11" /> <input name="Nombre" type="hidden" value="Situ" /> <input name="Desde" type="hidden" value="2018-05-01" /> <input name="Hasta" type="hidden" value="2018-05-17" /> <input name="ContadorVisitas" type="hidden" value="" /> <input name="ContadorClics" type="hidden" value="" /> <!--Modal--></p>
...
<form onsubmit="mensaje()" action="http://dechali.com/lead/public/index.php/guardar" method="POST"><input name="_token" type="hidden" value="A0CA0l9h9dqgvHIufUtPreW26Rpv34wq3mOrf3zg" /> <input name="_token" type="hidden" value="A0CA0l9h9dqgvHIufUtPreW26Rpv34wq3mOrf3zg" /> <input name="id_landing" type="hidden" value="11" />
