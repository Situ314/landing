...
<div class="col-md-12" style="padding-left:0px; padding-right:0px; position:relative; text-align:center; width:100%"><img class="land2_banner" id="land2_banner" src="http://dechali.com/lead/public/img/images/evento%20tarija%202018.jpg" style="height:300px; overflow:visible; width:900px" />
<div style="left:20px; position:absolute; top:20px"><img class="img-responsive" id="land2_logo1" src="http://dechali.com/lead/public/img/images/Logo%20Oficial%20MyDream(1).png" style="height:82px; width:200px" /><strong style="color:white; font-family:inherit; font-size:2.5rem; font-weight:bold">ESTE ES UN CHISTE&nbsp; &nbsp; rrecta desde China para Bolivia</strong>

<p><br />
Nuestra colecci&oacute;n de 10 videos te permitir&aacute; conocer todo lo que necesitas saber para una importaci&oacute;n adecuada</p>
<br />
...
<div class="col-md-5"><img class="img-fluid" id="image4" src="http://dechali.com/lead/public/img/images/1000Likes.jpg" style="height:500px; width:500px" /></div>
</div>
&nbsp;
...
<p><input name="CodLanding" type="hidden" value="14" /> <input name="Nombre" type="hidden" value="EMPRESA-TRES" /> <input name="Desde" type="hidden" value="2018-05-09" /> <input name="Hasta" type="hidden" value="2018-05-17" /> <input name="ContadorVisitas" type="hidden" value="" /> <input name="ContadorClics" type="hidden" value="" /> <!--Modal--></p>
...
<form onsubmit="mensaje()" action="http://dechali.com/lead/public/index.php/guardar" method="POST"><input name="_token" type="hidden" value="LnV48zvXmFhW0hc5CBjiKHQC4YRMvLMjobPjaXJJ" /> <input name="id_landing" type="hidden" value="14" />
<div class="form-group">
<div class="col-md-12">Correo electr&oacute;nico*:</div>
