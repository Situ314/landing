...
<div class="row">
<div class="col-md-5" style="overflow:hidden"><img alt="CKEditor logo" class="img-fluid" src="http://dechali.com/lead/public/img/images/boda%202018%20-%2050%20de%20descuento.jpg" style="height:500px; width:500px" /></div>
...
<h3>COMIENZA A PUBLICITAR TUS PRODUCTOS EN FACEBOOK!</h3>
</div>
</div>

<div style="font-size:20px; font-style:bold; padding:30px; text-align:center">
<p>Te regalamos una campa&ntilde;a gratuita en Facebook para tu empresa.</p>

<p>Puedes promocionar el producto o servicio que m&aacute;s desees.</p>

<p>Y s&iacute;, es 100% gratuito, sin ning&uacute;n costo adicional.</p>

<p>S&oacute;lo debes cumplir algunos requisitos para facilitar nuestro trabajo.</p>
</div>
</div>
</div>
...
<p><input name="PixeBoton" type="hidden" value="" /> <a class="button" data-toggle="modal" data-target="#myModal" href="#" style="background-color: #F9AF04;color: #fff;height:55px; text-decoration: none;">SI, DESEO ACCEDER A LA CAMPA&Ntilde;A GRATUITA</a> <!--<a data-toggle="modal" data-target="#myModal" href="#" data-toggle="modal" data-target="#myModal" data-dismiss="modal" onclick="modal(16)" id="landing-16">SI, DESEO ACCEDER A LA CAMPAÑA GRATUITA</a>--></p>
</div>
</div>
</div>
...
<div style="background-color:#00722a; color:white; margin-top:20px; padding:10px; position:relative; text-align:center"><img class="img-fluid" src="http://dechali.com/lead/public/img/images/Leads.png" style="height:69px; left:10%; position:absolute; top:50%; transform:translate(-10%, -50%); width:200px" />
...
<p><input name="CodLanding" type="hidden" value="16" /> <input name="Nombre" type="hidden" value="EMPRESA-TRES" /> <input name="Desde" type="hidden" value="2018-05-09" /> <input name="Hasta" type="hidden" value="2018-05-11" /> <input name="ContadorVisitas" type="hidden" value="" /> <input name="ContadorClics" type="hidden" value="" /> <!--modal--></p>
...
<form onsubmit="mensaje()" action="http://dechali.com/lead/public/index.php/guardar" method="POST"><input name="_token" type="hidden" value="Ns4O8XcWILpDE9wkZ8QfQsiNTiawPfBzfNNYcmGt" /> <input name="id_landing" type="hidden" value="16" />
...
<div class="col-md-12"><input name="campo2" type="text" /></div>
</div>
<br />
<br />
