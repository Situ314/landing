...
<h3>GABO</h3>
<img src="http://dechali.com/lead/public/img/images/es-de-cunumi-bolivia.png" style="display:block; height:200px; margin-left:auto; margin-right:auto; width:200px" /><br />
<br />
&nbsp;
...
<h1 style="margin-left:0px; margin-right:0px"><span style="font-size:48px"id="thoras">13</span></h1>
</div>
...
<div class="col-md-3" style="padding:3px">
<div style="background:#002060; border-color:white; border-radius:5px; border-style:solid; border-width:2px; color:white; font-size:300%; padding:5px">
<h1 style="margin-left:0px; margin-right:0px"><span style="font-size:48px"id="tminutos">47</span></h1>
</div>
...
<div class="col-md-3" style="padding:3px">
<div style="background:#002060; border-color:white; border-radius:5px; border-style:solid; border-width:2px; color:white; font-size:300%; padding:5px">
<h1 style="margin-left:0px; margin-right:0px"><span style="font-size:48px"id="tsegundos">4</span></h1>
</div>
...
<p><input name="CodLanding" type="hidden" value="15" /> <input name="Nombre" type="hidden" value="EMPRESA-TRES" /> <input name="Desde" type="hidden" value="2018-05-09" /> <input name="Hasta" type="hidden" value="2018-05-18" /> <input name="ContadorVisitas" type="hidden" value="" /> <input name="ContadorClics" type="hidden" value="" /> <!--Modal--></p>
...
<form onsubmit="mensaje()" action="http://dechali.com/lead/public/index.php/guardar" method="POST"><input name="_token" type="hidden" value="LnV48zvXmFhW0hc5CBjiKHQC4YRMvLMjobPjaXJJ" /> <input name="id_landing" type="hidden" value="15" />
<div class="form-group">
<div class="col-md-12">Cuanto gana?:</div>
