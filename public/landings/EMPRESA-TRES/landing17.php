...
<div class="row">
<div class="col-md-6" style="color:white"><img id="plant4_banner" src="http://www.printawallpaper.com/upload/designs/red_diamond_detail.jpg" style="height:250px; overflow:visible; position:absolute; width:200%" />
<div style="left:60px; position:absolute; top:60px">
<h1>PLANTILLA DE PRUEBA!!!!</h1>
&nbsp;

<p>10% de descueneto!!</p>
</div>
</div>
...
<p>Esta promoci&oacute;n finaliza el 24/05/2018<br />
<br />
...
<p><input name="CodLanding" type="hidden" value="17" /> <input name="Nombre" type="hidden" value="EMPRESA-TRES" /> <input name="Desde" type="hidden" value="2018-05-09" /> <input name="Hasta" type="hidden" value="2018-05-24" /> <input name="ContadorVisitas" type="hidden" value="" /> <input name="ContadorClics" type="hidden" value="" /> <!--Modal--></p>
...
<form onsubmit="mensaje()" action="http://dechali.com/lead/public/index.php/guardar" method="POST"><input name="_token" type="hidden" value="Ns4O8XcWILpDE9wkZ8QfQsiNTiawPfBzfNNYcmGt" /> <input name="id_landing" type="hidden" value="17" />
<div class="form-group">
<div class="col-md-12">Holaa*:</div>
...
var countDownDate = new Date("2018-05-24 23:59:59").getTime();
