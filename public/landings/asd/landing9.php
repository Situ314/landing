...
<div class="col-md-12" style="padding-left:0px; padding-right:0px; position:relative; text-align:center; width:100%"><img src="http://data.1freewallpapers.com/download/dark-living-room.jpg" style="height:450px; overflow:visible; width:100%" />
<div style="left:20px; position:absolute; top:20px"><img class="img-responsive" src="https://medic-trust.com/assets/logo-icon-9b77a4d938aa060a0e998bceb1e90fb3.png" style="height:64px; width:200px" />
...
<p>Esta Promoci&oacute;n finaliza el 08/05/2018</p>
...
<p><input name="CodLanding" type="hidden" value="9" /> <input name="Nombre" type="hidden" value="asd" /> <input name="Desde" type="hidden" value="2018-05-01" /> <input name="Hasta" type="hidden" value="2018-05-08" /> <input name="ContadorVisitas" type="hidden" value="" /> <input name="ContadorClics" type="hidden" value="" /> <!--Modal--></p>
...
<form onsubmit="mensaje()" action="http://localhost:8080/landing/public/index.php/guardar" method="POST"><input name="_token" type="hidden" value="fBgA87r3RWBXkQL7fG7oBhBQFYvhjsLA36SW1bNg" /> <input name="id_landing" type="hidden" value="9" /><br />
<input name="num_campos" type="hidden" value="0" />
...
var countDownDate = new Date("2018-05-08 23:59:59").getTime();
