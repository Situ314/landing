...
<div class="col-md-12" style="padding-left:0px; padding-right:0px; position:relative; text-align:center; width:100%"><img class="land2_banner" id="land2_banner" src="http://data.1freewallpapers.com/download/dark-living-room.jpg" style="height:450px; overflow:visible; width:100%" />
<div style="left:20px; position:absolute; top:20px"><img class="img-responsive" id="land2_logo1" src="https://medic-trust.com/assets/logo-icon-9b77a4d938aa060a0e998bceb1e90fb3.png" style="height:124px; width:142px" />
...
<p><input name="CodLanding" type="hidden" value="6" /> <input name="Nombre" type="hidden" value="asd" /> <input name="Desde" type="hidden" value="2018-04-02" /> <input name="Hasta" type="hidden" value="2018-04-30" /> <input name="ContadorVisitas" type="hidden" value="" /> <input name="ContadorClics" type="hidden" value="" /> <!--Modal--></p>
...
<form onsubmit="mensaje()" action="http://dechali.com/lead/public/index.php/guardar" method="POST"><input name="_token" type="hidden" value="JDukjrMXcomjy8vCngvLcN7JQZIci7gKxcAtpyRw" /> <input name="id_landing" type="hidden" value="6" />
<div class="form-group">
<div class="col-md-12">prueba*:</div>

<div class="col-md-12"><select name="campo1" required=""><option value="3|19">opcion1</option><option value="3|20">opcion2</option><option value="3|21">opcion3</option><option value="3|22">opcion4</option> </select></div>
</div>
<br />
