...
<div class="row">
<div class="col-md-6" style="color:white"><img id="plant4_banner" src="http://www.printawallpaper.com/upload/designs/red_diamond_detail.jpg" style="height:300px; overflow:visible; position:absolute; width:200%" />
...
<div class="plant4_cont" style="background:white; color:black; padding:20px">
...
<div class="row">
<div class="col-md-5" id="img_pasos"><img class="img-fluid" id="image4" src="http://icons.iconarchive.com/icons/xenatt/the-circle/512/App-Adobe-Update-icon.png" /></div>
...
<div class="row" id="notas" style="background:#cacaca; padding:10px 170px 10px 170px; text-align:center">
<div class="col-md-12">&nbsp;
<div style="color:red">
...
<div class="row" id="preguntas" style="padding:10px 80px 10px 80px">
<div class="col-md-12">&nbsp;
...
<p><img src="http://dechali.com/lead/public/img/images/Facebook.png" style="height:50px; width:50px" /> <img src="http://dechali.com/lead/public/img/images/Instagram.png" style="height:50px; width:50px" /></p>
</div>
</div>
</div>
...
<p>Esta promoci&oacute;n finaliza el 22/05/2018<br />
<br />
...
<p><input name="CodLanding" type="hidden" value="4" /> <input name="Nombre" type="hidden" value="Dream" /> <input name="Desde" type="hidden" value="2018-04-24" /> <input name="Hasta" type="hidden" value="2018-05-22" /> <input name="ContadorVisitas" type="hidden" value="" /> <input name="ContadorClics" type="hidden" value="" /> <!--Modal--></p>
...
<form onsubmit="mensaje()" action="http://dechali.com/lead/public/index.php/guardar" method="POST"><input name="_token" type="hidden" value="JDukjrMXcomjy8vCngvLcN7JQZIci7gKxcAtpyRw" /> <input name="id_landing" type="hidden" value="4" />
<div class="form-group">
<div class="col-md-12">Servicio*:</div>

<div class="col-md-12"><select name="campo1" required=""><option value="2|10">Sitios Web</option><option value="2|11">Campa&ntilde;as Publicitarias en Facebook</option><option value="2|12">Identidad Corporativa</option><option value="2|13">Desarrollo de Sistemas</option><option value="2|14">Talleres de Entrenamiento Corporativo</option><option value="2|15">Plan de Marketing Integral</option> </select></div>
</div>
<br />
...
var countDownDate = new Date("2018-05-22 23:59:59").getTime();
