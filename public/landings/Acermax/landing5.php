...
<div class="row">
<div class="col-md-6" style="color:white"><img id="plant4_banner" src="http://dechali.com/lead/public/img/images/portada3.jpg" style="height:400px; overflow:visible; position:absolute; width:200%" />
...
<p>Esta promoci&oacute;n finaliza el 17/05/2018<br />
<br />
...
<p><input name="CodLanding" type="hidden" value="5" /> <input name="Nombre" type="hidden" value="Acermax" /> <input name="Desde" type="hidden" value="2018-05-06" /> <input name="Hasta" type="hidden" value="2018-05-17" /> <input name="ContadorVisitas" type="hidden" value="" /> <input name="ContadorClics" type="hidden" value="" /> <!--Modal--></p>
...
<form onsubmit="mensaje()" action="http://dechali.com/lead/public/index.php/guardar" method="POST"><input name="_token" type="hidden" value="JDukjrMXcomjy8vCngvLcN7JQZIci7gKxcAtpyRw" /> <input name="id_landing" type="hidden" value="5" />
