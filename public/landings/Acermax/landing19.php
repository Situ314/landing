...
<div class="row">
<div class="col-md-12"><img class="plan3_banner" src="http://dechali.com/lead/public/img/images/logo-acermax.jpg" style="display:block; height:169px; margin-left:auto; margin-right:auto; width:200px" /></div>
</div>
...
<h3><span style="font-size:24px"><strong>50% DE DESCUENTO</strong></span></h3>
<img src="http://dechali.com/lead/public/img/images/Post%201%20-%20semana%205.jpg" style="display:block; height:200px; margin-left:auto; margin-right:auto; width:200px" /><br />
<br />
&nbsp;
<p>LL&Eacute;VATELA CON EL 50% DE DESCUENTO</p>
</div>
</div>

<div class="col-md-6 col-sm-12 col-xs-12 row-eq-height" id="pla3_cont2" style="padding-left:0px; padding-right:0px; position:relative; text-align:center"><img src="https://http2.mlstatic.com/fondo-pantalla-verde-chromakey-para-estudio-fotografico-D_NQ_NP_18551-MLM20157874753_092014-F.jpg" style="height:100%; object-fit:cover; width:375px" />
...
<h1 style="margin-left:0px; margin-right:0px"><span style="font-size:48px" id="tdias">9</span></h1>
</div>
...
<h1 style="margin-left:0px; margin-right:0px"><span style="font-size:48px"id="thoras">1</span></h1>
</div>
...
<div class="col-md-3" style="padding:3px">
<div style="background:#002060; border-color:white; border-radius:5px; border-style:solid; border-width:2px; color:white; font-size:300%; padding:5px">
<h1 style="margin-left:0px; margin-right:0px"><span style="font-size:48px"id="tminutos">45</span></h1>
</div>
...
<div class="col-md-3" style="padding:3px">
<div style="background:#002060; border-color:white; border-radius:5px; border-style:solid; border-width:2px; color:white; font-size:300%; padding:5px">
<h1 style="margin-left:0px; margin-right:0px"><span style="font-size:48px"id="tsegundos">31</span></h1>
</div>
...
<input name="PixeBoton" type="hidden" value="" /> <a class="button2" data-toggle="modal" data-target="#myModal" href="#">QUIERO LA CALAMINA</a><br />
&nbsp;
<hr />&nbsp;
...
<p>Esta promoci&oacute;n finaliza el 18/05/2018<br />
<br />
Leads es una p&aacute;gina de aterrija creada por DeChaLi<br />
...
<p><input name="CodLanding" type="hidden" value="19" /> <input name="Nombre" type="hidden" value="Acermax" /> <input name="Desde" type="hidden" value="2018-05-09" /> <input name="Hasta" type="hidden" value="2018-05-18" /> <input name="ContadorVisitas" type="hidden" value="" /> <input name="ContadorClics" type="hidden" value="" /> <!--Modal--></p>
...
<form onsubmit="mensaje()" action="http://dechali.com/lead/public/index.php/guardar" method="POST"><input name="_token" type="hidden" value="3Fhq6jbj5AvPxaSJpCEsBNnGFq18YWlUJ2wm71nn" /> <input name="id_landing" type="hidden" value="19" />
<div class="form-group">
<div class="col-md-12">&iquest;Qu&eacute; modelo de calamina necesitas?*:</div>
...
var countDownDate = new Date("2018-05-18 23:59:59").getTime();
