...
<p><input name="PixeBoton" type="hidden" value="" /> <a class="button" data-toggle="modal" data-target="#myModal" href="#" style="background-color: #F9AF04;color: #fff;height:55px; text-decoration: none;">SI, DESEO ACCEDER A LA CAMPA&Ntilde;A GRATUITA</a> <!--<a data-toggle="modal" data-target="#myModal" href="#" data-toggle="modal" data-target="#myModal" data-dismiss="modal" onclick="modal(9)" id="landing-9">SI, DESEO ACCEDER A LA CAMPAÑA GRATUITA</a>--></p>
</div>
</div>
</div>
...
<div>
<p>Esta Promoci&oacute;n finaliza el 09/05/2018</p>
...
<p><input name="CodLanding" type="hidden" value="9" /> <input name="Nombre" type="hidden" value="EMPRESA-NUEVA" /> <input name="Desde" type="hidden" value="2018-05-07" /> <input name="Hasta" type="hidden" value="2018-05-09" /> <input name="ContadorVisitas" type="hidden" value="" /> <input name="ContadorClics" type="hidden" value="" /> <!--modal--></p>
...
<form onsubmit="mensaje()" action="http://dechali.com/lead/public/index.php/guardar" method="POST"><input name="_token" type="hidden" value="nadbRrPGXuPEnFL0mmMCx06zuQWLHGr2YaRn5686" /> <input name="_token" type="hidden" value="nadbRrPGXuPEnFL0mmMCx06zuQWLHGr2YaRn5686" /> <input name="id_landing" type="hidden" value="9" />
...
var countDownDate = new Date("2018-05-09 23:59:59").getTime();
