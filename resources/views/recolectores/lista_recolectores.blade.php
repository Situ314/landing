            ...
            <div class="desplegable">
                <div class="panel panel-default col-md-5 col-md-offset-3">
                    <div class="panel-body ">
                        {!! Form::open(['method' => 'POST','route' => 'Recolector.store'])!!} 
...
<!--                                    <div style="display: inline-block; text-align: center;">
                                    ...
                                    <div style="display: inline-block; text-align: center;">
                                        {!! Form::open(['method' => 'DELETE', 'route' => ['Recolector.destroy',$recolector->id]]) !!}
                        ...
                        <tr class="editar" id="<?php echo 'editar'.$cont; ?>">
                            {!! Form::model($recolector,['route' => ['Recolector.update', $recolector->id], 'method'=>'put']) !!}
                            <td><?php echo $cont; ?></td>
                            <td>
                                <input type="text" name="nuevo" value="{{$recolector->Nombre}}">
                            </td>
                            <td>
